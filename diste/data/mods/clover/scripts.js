...
const Scripts = {
  ...
  pokemon: {
    ...
    ignoringAbility() {
      ...
      return !!(this.battle.gen >= 5 && !this.isActive || (this.volatiles["gastroacid"] || neutralizinggas && this.ability !== "neutralizinggas" || genwunRoom || retroSuppression) && !this.getAbility().isPermanent);
    },
