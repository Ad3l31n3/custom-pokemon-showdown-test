...
const Moves = {
  ...
  wonderroom: {
    ...
    condition: {
      ...
      onModifyMove(move, source, target) {
        if (!move.overrideOffensiveStat || source.hasItem("Ar Helmet"))
          return;
  ...
  confide: {
    // TODO: Add Amplifier interaction
    inherit: true,
    type: "Sound",
    priority: 1,
  ...
  cosmicpower: {
    // TODO: Add +1 speed boost during Starfield
    inherit: true,
    type: "Cosmic",
    isNonstandard: null
  },
  ...
  destinybond: {
    ...
    condition: {
      ...
      onFaint(target, source, effect) {
        ...
        if (!source || !effect || target.isAlly(source) || immune.includes(source.baseSpecies.baseSpecies))
          return;
  ...
  firepledge: {
    // TODO: Secondary: 100% chance to trigger Sea of Fire
    inherit: true,
    basePower: 70,
  ...
  grasspledge: {
    // TODO: Secondary: 100% chance to trigger Swamp
    inherit: true,
    basePower: 80,
    basePowerCallback(pokemon, target, move) {
      return move.basePower;
  ...
  irontail: {
    // TODO: Add Iron Dust interaction
    inherit: true,
    accuracy: 80,
    flags: { contact: 1, protect: 1, mirror: 1, tail: 1 },
    isNonstandard: null
  ...
  meanlook: {
    // TODO: Add Graveyard interaction
    inherit: true,
    type: "Fear",
    pp: 15,
    flags: { protect: 1, reflectable: 1, mirror: 1 },
  ...
  mirrorshot: {
    // TODO: Mirror Dimension interaction
    inherit: true,
    type: "Glass",
    isNonstandard: null
  },
  ...
  moonlight: {
    // TODO: Eclipse, Full Moon and Fog interaction
    inherit: true,
  ...
  spiderweb: {
    // TODO: Add Web Field interaction
    inherit: true,
  ...
  spotlight: {
    // TODO: Add Aura Glow interaction
    inherit: true,
    onHit(target, source, move) {
  ...
  meltedplastic: {
    /** The move already exists in 'data/moves.ts' */
    inherit: true,
    isNonstandard: null
  },
  uproot: {
  ...
  darkening: {
    ...
    /** TODO?: This move is perish song but in 1 turn and only affects the target... */
  },
  nosedive: {
    inherit: true,
    accuracy: 100,
