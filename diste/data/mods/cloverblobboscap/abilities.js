...
const Abilities = {
  ...
  illusion: {
    ...
    onTryMove(source, target, move) {
      ...
      if (!source.illusion && moveIndex !== void 0 && moveIndex === sourceMoveIndex) {
        ...
        source.abilityState.replacedMoveIndex = void 0;
  ...
  slushrush: {
    ...
    onModifySpe(spe, pokemon) {
      if (this.field.isWeather(["hail", "snow", "hyperboreanarctic"])) {
  ...
  icebody: {
    ...
    onWeather(target, source, effect) {
      if (effect.id === "hail" || effect.id === "snow" || effect.id === "hyperboreanarctic") {
