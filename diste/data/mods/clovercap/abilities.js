...
const Abilities = {
  ...
  disguise: {
    ...
    onDamage(damage, target, source, effect) {
      if (effect && effect.effectType === "Move" && ["mimikyu", "mimikyutotem", "sabsute"].includes(target.species.id) && !target.transformed) {
    ...
    onUpdate(pokemon) {
      if (["mimikyu", "mimikyutotem", "sabsute"].includes(pokemon.species.id) && this.effectState.busted) {
        const speciesid = pokemon.species.id === "mimikyutotem" ? "Mimikyu-Busted-Totem" : pokemon.species.id === "sabsute" ? "Sabsute-Busted" : "Mimikyu-Busted";
