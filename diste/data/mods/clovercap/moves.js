...
const Moves = {
  ...
  telekinesis: {
    ...
    condition: {
      duration: 3,
      onStart(target) {
        if (["Diglett", "Dugtrio", "Palossand", "Sandygast", "Fusjahl"].includes(target.baseSpecies.baseSpecies) || ["Gengar-Mega", "Goryannus-Mega"].includes(target.baseSpecies.name)) {
  ...
  sleazyspores: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        ...
        if (!pokemon.runStatusImmunity("powder"))
          return;
