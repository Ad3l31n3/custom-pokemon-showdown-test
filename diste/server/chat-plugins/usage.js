    ...
    async format(target, room) {
      ...
      if (!target) {
        return this.sendReplyBox(
          '<b><u>Usage Stats</u></b><br /><p>Daily usage stats for most Clovermon Showdown formats can be found here:</p><ul><li><a href="https://usage.weedl.es">Usage Site</a></li></ul>'
        );
      }
